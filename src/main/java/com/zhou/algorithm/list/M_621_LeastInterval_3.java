 ...
 * <p>
 */
public class M_621_LeastInterval_3 {
    ...
    public static int leastInterval(char[] tasks, int n) {
        ...
        while (i < tasks.length) {
            ...
            if (taskQueue[queueArrayIndex] == null) {
                ...
                queueList.add(taskQueue[queueArrayIndex]);
            }
        ...
        //去除空queue
        for (Queue qtem : queueList) {
            while (((LinkedList) qtem).getLast() == null) {
                ((LinkedList) qtem).removeLast();
            }
        }
        // 填充就绪队列
        while (true) {
