 ...
 * <p>
 */
public class M_621_LeastInterval_2 {
    ...
    public static int leastInterval(char[] tasks, int n) {
        ...
        while (true) {
            ...
            Queue headNotNullContainsNull = new LinkedList();
            Queue headNotNullNotContainsNull = new LinkedList();
            for (Queue q : queueList) {
                ...
                if (q.element() == null) {
                   ...
                   q.poll();
                    ...
                    if (q.contains(null)) {
                        if(q.size()> headNotNullContainsNull.size()){
                            headNotNullContainsNull = q;
                        }
                    } else {
                        headNotNullNotContainsNull = q;
                    }
                }
            }
            ...
            if (!headNotNullContainsNull.isEmpty()) {
                //选长度最长的, 考虑重排的可能性
                getValueQueue = headNotNullContainsNull;
            } else if (!headNotNullNotContainsNull.isEmpty()) {
                getValueQueue = headNotNullNotContainsNull;
            }
